...
public class HomePage extends BasePage {
    ...
    private By timeLineButton = By.xpath("/html[1]/body[1]/div[8]/div[2]");
    private By todaysBar = By.xpath("//body[@class='forecast']/div[@id='week']/a[1]/span[3]/span[1]");
    ...
    private By calendarDates = By.xpath("//td[@class='is-today']//descendant:: button");
